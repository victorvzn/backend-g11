...
class ImagenesController(Resource):
    def post(self):
        # print(request.json)
        # Si queremos enviar informacion por el form-data ahora utilizaremos la propiedad 'form
        print(request.form)
        
        # Para obtener las llaves que contengan archivo 'files'
        print(request.files)
        ...
        # save sirve para guardar la imagen, pero utilizamos para que sea  un nombre valido 
