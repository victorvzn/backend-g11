...
class Seccion(conexion.Model):
    ...
    # si una columna sera utilizada como llave foranea entonces tenemos que
    # utilizar la clase ForeignKey, en ella usaremos el parametro 'column' en
    # el cual indicaremos LA TABLA
