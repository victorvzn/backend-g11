...
class Producto(models.Model):
    ...
    # updateAt > es el campo que se actualizara cada vez que modifique algun dato del registro con la fecha actual
    ...
    class Meta:
        ...
        db_table = 'productos'
        # vas a modificar el ordenamiento y sera primero el nombre de manera descendente y luego si es que hay una coincidencia en los nombres ordena esa coincidencia basandose ahora en el precio de manera ascendente
        ordering = ['-nombre', 'precio']
        # es que no se puede repetir la unicidad de dos registros tengan los mismo valores de estas columnas
